...
@Component
public class ValidateInstitutionWebsite implements ValidationInstitution{
    @Autowired
    ...
    public void validar(DataRegistrationInstitution dataRegistrationInstitution) throws MyException {
        ...
        Optional<Institution> optionalInstitution = institutionRepository.findByWebsite(dataRegistrationInstitution.website());
