...
export const AdminHomeData: React.FC<PropsAdminHomeData> = ({ admin, institution }) => {
  return (
    <div className="bg-gray-100 shadow-md rounded border border-gray-200 px-8 pt-8 pb-8 mb-4 m-8">
      <h2 className="text-4xl font-medium leading-6 text-sky-600">Administrador</h2>
      ...
      <h2 className="text-4xl mt-8 font-medium leading-6 text-sky-600 mt-4">Institución</h2>
      <div className="text-xl mt-4 ml-8 text-cyan-600">
